 ...
 */
class Midtrans_Snapinstmigs_Model_Standard extends Mage_Payment_Model_Method_Abstract {
	protected $_code = 'snapinstmigs';
	
	protected $_isInitializeNeeded      = true;
	protected $_canUseInternal          = true;
	protected $_canUseForMultishipping  = false;
	
	protected $_formBlockType = 'snapinstmigs/form';
  	protected $_infoBlockType = 'snapinstmigs/info';
	
	// call to redirectAction function at Veritrans_Vtweb_PaymentController
	public function getOrderPlaceRedirectUrl() {
		return Mage::getUrl('snapinstmigs/payment/redirect', array('_secure' => true));
	}
}
?>