 ...
 */
class Midtrans_Snapspec_Block_Form extends Mage_Payment_Block_Form
{
    ...
    protected function _construct()
    {
         parent::_construct();
		    ...
		    $this->setFormMessage(Mage::helper('snapspec/data')->_getFormMessage());
        $this->setTemplate('snapspec/form.phtml');
    }
}
?>