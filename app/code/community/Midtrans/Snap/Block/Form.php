 ...
 */
class Midtrans_Snap_Block_Form extends Mage_Payment_Block_Form
{
     ...
     $emoney = array();
      ...
      if (Mage::getStoreConfig('payment/vtweb/enable_bbmmoney') == '1') {
    	...
    	$this->setEmoney($emoney);*/
		  $this->setFormMessage(Mage::helper('snap/data')->_getFormMessage());
      $this->setTemplate('snap/form.phtml');
    }
}
?>